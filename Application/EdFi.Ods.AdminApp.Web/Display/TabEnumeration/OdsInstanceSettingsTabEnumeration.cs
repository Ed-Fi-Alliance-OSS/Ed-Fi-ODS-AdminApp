...
namespace EdFi.Ods.AdminApp.Web.Display.TabEnumeration
{
    public sealed class OdsInstanceSettingsTabEnumeration : Enumeration<OdsInstanceSettingsTabEnumeration>, ITabEnumeration
    {
        ...
        public static readonly OdsInstanceSettingsTabEnumeration EducationOrganizations = new OdsInstanceSettingsTabEnumeration(4, "Education Organizations", RouteHelpers.GetControllerName<EducationOrganizationsController>(), RouteHelpers.GetActionName<EducationOrganizationsController>(x => x.LocalEducationAgencies()));        
