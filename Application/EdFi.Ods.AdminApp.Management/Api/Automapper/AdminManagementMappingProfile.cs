    ...
    public class AdminManagementMappingProfile : Profile
    {
        public AdminManagementMappingProfile()
        {
            CreateMap<EdFiSchool, School>()
                ...
                .ForMember(dst => dst.PostSecondaryInstitutionId, opt => opt.MapFrom(src => src.Ext != null && src.Ext.TPDM != null && src.Ext.TPDM.PostSecondaryInstitutionReference == null ? null : src.Ext.TPDM.PostSecondaryInstitutionReference.PostSecondaryInstitutionId))
                ...
                .ForMember(dst => dst.AccreditationStatus, opt => opt.MapFrom(src => src.Ext != null && src.Ext.TPDM == null ? null : src.Ext.TPDM.AccreditationStatusDescriptor))
                .ForMember(dst => dst.FederalLocaleCode, opt => opt.MapFrom(src => src.Ext != null && src.Ext.TPDM == null ? null : src.Ext.TPDM.FederalLocaleCodeDescriptor))
                .ForMember(dst => dst.ImprovingSchool, opt => opt.MapFrom(src => src.Ext != null && src.Ext.TPDM == null ? null : src.Ext.TPDM.ImprovingSchool))
