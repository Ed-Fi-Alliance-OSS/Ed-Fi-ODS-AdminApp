...
namespace EdFi.Ods.AdminApp.Management.Tests.ClaimSetEditor
{
    ...
    public class ClaimSetFileImportCommandTests : SecurityDataTestBase
    {
        ...
        public void ShouldImportClaimSetResourceClaimWithAuthrozationStrategyOverrides()
        {
            ...
            SetupResourceClaims(testApplication, new List<string> { "TestParent1234"}, UniqueNameList("Child", 1));
        ...
        public void ShouldImportClaimSetResourceClaimWithChildrenAndAuthrozationStrategyOverrides()
        {
            ...
            SetupResourceClaims(testApplication, new List<string> { "TestParent1234" },
                new List<string> { "TestChild5678" });
                        ...
                        ""resourceClaims"": [
                          {
                            ...
                            ""AuthStrategyOverridesForCRUD"": [
                             ...
                             ""Children"": [
                                    {
                                        ""Name"": ""TestChild5678-TestParent1234"",
                                        ""Read"": true,
                                        ""Create"": true,
                                        ""Update"": true,
                                        ""Delete"": false,
